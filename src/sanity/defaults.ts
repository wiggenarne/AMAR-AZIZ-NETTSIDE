import type { LocaleString } from "./content";

type SiteContentDefaults = Record<string, LocaleString>;
...
export const artistInfoDefaults = {
  name: "Amar Aziz",
  ...
  contactHeading: { no: "Kontakt", en: "Contact" } as LocaleString,
  contactIntro: {
    no: "Alle verk er originaler. Ta direkte kontakt for pris, tilgjengelighet og frakt.",
    en: "All works are originals. Contact the artist directly for price, availability and shipping.",
  } as LocaleString,
  contactEmailLabel: { no: "E-post", en: "Email" } as LocaleString,
  contactPhoneLabel: { no: "Telefon", en: "Phone" } as LocaleString,
  contactAddressLabel: { no: "Studioadresse", en: "Studio address" } as LocaleString,
  contactSocialLabel: { no: "Følg Amar", en: "Follow Amar" } as LocaleString,
  born: 1951,
  birthplace: "Lahore, Pakistan",
  aboutHeading: { no: "Om Amar Aziz", en: "About Amar Aziz" } as LocaleString,
  bioNo: [
  ...
  educationTitle: { no: "Utdanning", en: "Education" } as LocaleString,
  education: [
    { years: "2014–2018", text: { no: "Kunsthøyskolen i Holbæk, Danmark", en: "Holbæk Art School, Denmark" } },
    { years: "2009–2010", text: { no: "Praktisk-pedagogisk utdanning i kunst og håndverk, HIO", en: "Practical-Pedagogical Education in Art and Crafts, HIO" } },
    { years: "1977–1980", text: { no: "Grafisk design, Statens Håndverks- og kunstindustriskole (SHKS), Oslo", en: "Graphic Design, National College of Art and Design (SHKS), Oslo" } },
    { years: "1975–1977", text: { no: "Interiørarkitektur, Statens Håndverks- og kunstindustriskole (SHKS), Oslo", en: "Interior Architecture, National College of Art and Design (SHKS), Oslo" } },
    { years: "1966–1969", text: { no: "Bachelor i arkitektur, National College of Arts, Lahore", en: "Bachelor of Architecture, National College of Arts, Lahore" } },
  ],
  careerTitle: { no: "Karriere", en: "Career" } as LocaleString,
  career: [
    { years: "2004–", text: { no: "Profesjonell billedkunstner", en: "Professional visual artist" } },
    { years: "1984–2004", text: { no: "Grafisk designer, Freia Oslo", en: "Graphic designer, Freia Oslo" } },
  ],
  membershipsTitle: { no: "Medlemskap", en: "Memberships" } as LocaleString,
